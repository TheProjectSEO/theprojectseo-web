  ...
  tiers: [
    {
      ...
      price: '$80',
      period: '/link',
      description: 'Niche-relevant, quality sites to build your initial backlink profile.',
      features: [
        'Niche-relevant sites',
        'Manually vetted for quality',
        'Contextual placement',
        'Dofollow links',
    ...
    },
    {
      ...
      price: '$120',
      period: '/link',
      description: 'Established authority sites for scaling link acquisition.',
      features: [
    ...
    },
    {
      ...
      price: '$200',
      period: '/link',
      description: 'High-authority publications for competitive industries.',
      features: [
    ...
    },
    {
      ...
      price: '$350',
      period: '/link',
      description: 'Premium, top-tier domains for maximum authority transfer.',
      features: [
        'Premium top-tier domains',
        'Forbes, TechCrunch-level sites',
...
const faqData = [
  ...
  },
  {
    ...
    answer: 'Link building pricing varies by domain rating and quality. Our per-link pricing starts at $80 for DR 10-20 sites, $120 for DR 30-40 sites, $200 for DR 50-60 high-authority publications, and $350 for DR 70+ premium top-tier domains. Every link is manually vetted for relevance and quality. Link building typically represents 32-36% of total SEO budget.',
  },
  {
