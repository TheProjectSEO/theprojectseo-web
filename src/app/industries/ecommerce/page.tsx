    ...
    <div className="bg-paper py-24">
      <Container>
        <div className="text-center mb-16">
          ...
          <Heading as="h2" className="mt-2">
            How we drive e-commerce SEO results.
          </Heading>
        </div>
      ...
      <Container>
        <div className="flex flex-col items-center gap-8 text-center lg:flex-row lg:justify-between lg:text-left">
          <div className="max-w-xl">
            <Subheading>Ready to Grow Your Online Revenue?</Subheading>
            <Heading as="h2" className="mt-2">
              Let&apos;s build your e-commerce SEO growth engine.
            </Heading>
            <Lead className="mt-6">
              Partner with SEO experts who understand e-commerce metrics, product discovery, and
              the online shopping journey. We&apos;ll help you turn organic search into your most
        ...
        <p className="mt-6 text-xs text-ash text-center lg:text-left">
          Free consultation includes e-commerce-specific keyword research, competitor analysis, and growth roadmap.
        </p>
      </Container>
    </div>
  )
