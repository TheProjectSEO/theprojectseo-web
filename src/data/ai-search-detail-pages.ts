...
function createAiSearchDetailPage(
  spec: AiSearchDetailSpec,
  ...
  return {
    ...
    searchJourneys: [
      {
        ...
        examples: [
          spec.promptExamples[0],
          `what is ${spec.name.toLowerCase()} and when is it useful`,
        ],
        conversion:
          "supporting guide, methodology, evidence page, or relevant service route",
      },
      {
        stage: "Explore",
        ...
        examples: [
          spec.promptExamples[1],
          `companies that provide ${spec.name.toLowerCase()}`,
        ],
        conversion:
          "qualified visit to a service, comparison, industry, or proof page",
      },
      {
        stage: "Compare",
        ...
        examples: [
          spec.promptExamples[2],
          `compare ${spec.name.toLowerCase()} approaches for a growing company`,
        ],
        conversion:
          "pricing review, consultation, case evidence, or vendor shortlist",
      },
      {
        stage: "Validate",
        ...
        examples: [
          spec.promptExamples[3],
          `is TheProjectSEO suitable for Google and AI search optimization`,
        ],
        conversion:
          "contact, proposal request, scoped assessment, or sales-qualified opportunity",
      },
    ],
    ...
    aiVisibility: {
      ...
      lead: "A platform page needs a narrow operational focus without pretending the rest of search disappears. We build one source foundation, then apply the access, research, and measurement details that differ by product.",
      ...
      workstreams: [
        {
          ...
          output:
            "access matrix, crawl evidence, rendered-page QA, and prioritized defects",
        },
        {
          ...
          output:
            "stored responses, source map, accuracy review, and opportunity notes",
        },
        {
          ...
          output:
            "entity register, fact corrections, source priorities, and appropriate markup",
        },
        {
          ...
          output:
            "landing-page improvements, internal journeys, conversion events, and CRM cohort plan",
        },
      ],
    },
    ...
    architecture: [
      {
        ...
        intent:
          "What does this company provide, for whom, and under what conditions?",
        examples: spec.assetExamples[0],
        signal:
          "clear offer, audience, features, facts, limitations, evidence, and conversion path",
      },
      {
        ...
        signal:
          "direct answer, method, example, source, update date, and deeper supporting detail",
      },
      {
        ...
        signal:
          "declared criteria, balanced trade-offs, current facts, and transparent commercial relationship",
      },
      {
        ...
        signal:
          "method, sample or scope, date, definitions, raw context, limitations, and accountable author",
      },
      {
        pageType: "Entity and trust surfaces",
        intent: "Who is responsible and can the facts be corroborated?",
        examples:
          "about, people, author, contact, location, policy, profile, publication, and review pages",
        signal:
          "consistent names, roles, credentials, locations, ownership, policies, and independent references",
      },
    ],
    ...
    process: [
      {
        ...
        output:
          "audience map, journey, commercial questions, exclusions, and success definitions",
      },
      {
        number: "02",
        cadence: "Baseline",
        ...
        output:
          "baseline dataset, access matrix, source gap, accuracy log, and technical backlog",
      },
      {
        number: "03",
        cadence: "Design",
        ...
        output:
          "content architecture, briefs, entity map, authority plan, and specifications",
      },
      {
        number: "04",
        cadence: "Implement",
        ...
        output:
          "implemented cohort, QA evidence, release notes, and measurement annotation",
      },
      {
        number: "05",
        cadence: "Observe",
        ...
        output:
          "comparative response set, search trend, referral cohort, and finding log",
      },
      {
        number: "06",
        cadence: "Iterate",
        ...
        output:
          "next roadmap, repeatable standards, refreshed priorities, and stakeholder report",
      },
    ],
    ...
    measurement: [
      {
        ...
        source:
          "stored responses with prompt, platform, market, date, interface, and run conditions",
      },
      {
        ...
        source:
          "captured source lists, destination URLs, screenshots or exports, and repeat runs",
      },
      {
        ...
        source:
          "approved fact register, response audit, source review, and correction log",
      },
      {
        ...
        source:
          "Search Console, Bing data, analytics, server or referral data, and release annotations",
      },
      {
        ...
        source:
          "analytics, CRM, commerce or product data, attribution notes, and stakeholder validation",
      },
    ],
    evidence: {
    ...
    faqs: [
      ...
      {
        question:
          "Does adding FAQ schema or an llms.txt file guarantee AI visibility?",
        answer:
  ...
  relatedLinks: [
    {
      ...
      label: "AEO services",
      description: "Structure useful direct answers and supporting evidence.",
    },
    {
      href: "/services/ai-search/chatgpt-seo",
      label: "ChatGPT SEO",
      description: "Audit OpenAI crawler access, sources, and responses.",
    },
    {
      href: "/services/ai-search/google-ai-overviews-optimization",
      label: "Google AI Overviews",
      description: "Apply Google’s published Search requirements.",
    },
    {
      href: "/services/ai-search/llm-visibility-tracking",
      label: "Visibility tracking",
      description: "Build a reproducible prompt and citation dataset.",
    },
  ],
});
  ...
  relatedLinks: [
    {
      ...
      label: "GEO services",
      description:
        "Improve retrieval, citations, and brand representation broadly.",
    },
    {
      href: "/services/ai-search/perplexity-seo",
      label: "Perplexity SEO",
      description: "Work with Perplexity’s published crawler controls.",
    },
    {
      href: "/services/technical-seo",
      label: "Technical SEO",
      description: "Repair crawl, rendering, index, and template foundations.",
    },
    {
      href: "/services/ai-search/llm-visibility-tracking",
      label: "LLM tracking",
      description: "Version prompts and preserve answer conditions.",
    },
  ],
});
  ...
  relatedLinks: [
    {
      href: "/services/ai-search/chatgpt-seo",
      label: "ChatGPT SEO",
      description: "Review OpenAI-specific search and crawler controls.",
    },
    {
      href: "/services/ai-search/entity-seo",
      label: "Entity SEO",
      description: "Align factual identity across owned and external sources.",
    },
    {
      href: "/services/content",
      label: "SEO content",
      description: "Create expert-led technical and commercial sources.",
    },
    {
      href: "/services/ai-search/llm-visibility-tracking",
      label: "LLM tracking",
      description: "Measure response conditions, citations, and accuracy.",
    },
  ],
});
...
const gemini = createAiSearchDetailPage({
  ...
  faqs: [
    ...
    {
      question:
        "Is Gemini visibility the same as Google AI Overviews visibility?",
      answer:
  ...
  relatedLinks: [
    {
      href: "/services/ai-search/google-ai-overviews-optimization",
      label: "Google AI Overviews",
      description: "Follow Google’s published Search eligibility guidance.",
    },
    {
      href: "/services/ai-search/entity-seo",
      label: "Entity SEO",
      description: "Clarify facts and relationships across the web.",
    },
    {
      href: "/services/seo",
      label: "SEO services",
      description: "Strengthen the full Google and Bing search system.",
    },
    {
      href: "/services/ai-search/llm-visibility-tracking",
      label: "LLM tracking",
      description: "Keep Gemini observations methodologically separate.",
    },
  ],
});
  ...
  relatedLinks: [
    {
      href: "/services/ai-search/geo",
      label: "GEO services",
      description: "Apply entity clarity to generated-answer discovery.",
    },
    {
      href: "/services/ai-search/aeo",
      label: "AEO services",
      description: "Connect facts to useful, verifiable answers.",
    },
    {
      href: "/services/local-seo",
      label: "Local SEO",
      description:
        "Align location entities, listings, profiles, and landing pages.",
    },
    {
      href: "/services/ai-search/llm-visibility-tracking",
      label: "LLM tracking",
      description: "Audit how AI systems represent the entity.",
    },
  ],
});
  ...
  relatedLinks: [
    {
      href: "/services/seo",
      label: "SEO services",
      description: "Build the complete Google and Bing visibility system.",
    },
    {
      href: "/services/technical-seo",
      label: "Technical SEO",
      description: "Repair crawl, index, rendering, and template issues.",
    },
    {
      href: "/services/ai-search/gemini-seo",
      label: "Gemini SEO",
      description: "Measure Gemini answers as a separate Google product.",
    },
    {
      href: "/services/ai-search/llm-visibility-tracking",
      label: "Visibility tracking",
      description: "Preserve prompts, sources, SERP features, and conditions.",
    },
  ],
});
  ...
  relatedLinks: [
    {
      ...
      description: "Turn visibility observations into implementation work.",
    },
    {
      href: "/services/ai-search/chatgpt-seo",
      label: "ChatGPT SEO",
      description: "Apply OpenAI-specific access and source analysis.",
    },
    {
      href: "/services/ai-search/google-ai-overviews-optimization",
      label: "Google AI Overviews",
      description: "Connect observations to Search eligibility and reporting.",
    },
    {
      href: "/services/analytics/seo-reporting",
      label: "SEO reporting",
      description: "Integrate search, analytics, CRM, and commercial context.",
    },
  ],
});
  ...
  relatedLinks: [
    {
      href: "/services/ai-search/chatgpt-seo",
      label: "ChatGPT SEO",
      description: "Compare OpenAI-specific retrieval and crawler controls.",
    },
    {
      href: "/services/ai-search/geo",
      label: "GEO services",
      description: "Improve the wider source and authority system.",
    },
    {
      href: "/services/content",
      label: "SEO content",
      description: "Create current, useful, source-worthy assets.",
    },
    {
      href: "/services/ai-search/llm-visibility-tracking",
      label: "LLM tracking",
      description: "Store prompts, citations, URLs, and response conditions.",
    },
  ],
});
