...
const seo: IndustryLeadPageData = {
  ...
  searchJourneys: [
    {
      ...
      examples: ['how to improve Shopify category visibility', 'reduce month-end close time'],
      conversion: 'useful guide, tool, category education, or relevant solution path',
    },
    {
      stage: 'Evaluate',
      ...
      examples: ['technical SEO agency for ecommerce', 'best tax software for small business'],
      conversion: 'service, product, industry, location, comparison, trial, or consultation',
    },
    {
      stage: 'Validate',
      ...
      examples: ['agency x case studies and pricing', 'product x integrations and limitations'],
      conversion: 'case study, methodology, pricing, product evaluation, or qualified conversation',
    },
    {
      stage: 'Act',
      ...
      conversion: 'qualified lead, trial, appointment, order, opportunity, or revenue event',
    },
  ],
  ...
  aiVisibility: {
    ...
    lead:
      'AI-assisted search expands the surface area of discovery, but it does not replace the web. Eligible, useful, accessible pages and credible sources still underpin many generated answers. The added work is understanding prompts, retrieval sources, entities, citations, and factual representation.',
    platforms: [
      'Google Search',
      'Google AI Overviews',
      'Google AI Mode',
    ...
    workstreams: [
      {
        ...
        output: 'technical backlog, page ownership map, search baseline, and release QA',
      },
      {
        ...
        output: 'answer inventory, entity map, claim register, and structured-data plan',
      },
      {
        ...
        output: 'citation-source graph, authority roadmap, and correction opportunities',
      },
      {
        ...
        output: 'versioned observations, competitor movement, accuracy log, and decisions',
      },
    ],
  },
  ...
  architecture: [
    {
      ...
      examples: 'product, category, service, capability, solution, and use-case pages',
      signal: 'explicit offer, audience, facts, boundaries, proof, and conversion route',
    },
    {
      ...
      signal: 'real expertise or presence, distinct facts, appropriate proof, and local action',
    },
    {
      pageType: 'Comparison and evaluation',
      intent: 'How should I choose?',
      examples: 'alternatives, versus, pricing, implementation, compatibility, and criteria',
      signal: 'declared methodology, balanced differences, current sources, and next step',
    },
    {
      pageType: 'Education and tools',
      intent: 'Help me understand or complete the task',
      examples: 'guides, research, calculators, checklists, templates, and glossaries',
      signal: 'original utility, expert or source review, update rule, and relevant commercial path',
    },
    {
      pageType: 'Evidence and trust',
      intent: 'Can I verify the organization?',
      examples: 'case studies, company, people, methodology, policies, reviews, and sources',
      signal: 'approved facts, periods, methods, named ownership, limitations, and contact',
    },
  ],
  ...
  process: [
    {
      ...
      output: 'business map, stakeholder plan, data access, risks, and outcome definitions',
    },
    {
      number: '02',
      cadence: 'Weeks 1–3',
      ...
      output: 'evidence-backed findings, baseline, opportunity model, and data gaps',
    },
    {
      number: '03',
      cadence: 'Weeks 3–5',
      ...
      output: 'page map, briefs, developer tickets, internal links, and sequenced roadmap',
    },
    {
      number: '04',
      cadence: 'Monthly',
      ...
      output: 'released changes, reviewed pages, resolved defects, and decision log',
    },
    {
      number: '05',
      cadence: 'Monthly',
      ...
      output: 'source assets, relevant mentions or links, entity fixes, and outreach learning',
    },
    {
      number: '06',
      ...
      output: 'decision report, experiment readout, confidence notes, and updated roadmap',
    },
  ],
  ...
  measurement: [
    {
      ...
      definition: 'Priority recommendations shipped, affected templates validated, valuable pages indexable, regressions detected, and release defects resolved.',
      source: 'tickets, crawl data, logs where available, Search Console, and QA records',
    },
    {
      name: 'Qualified search visibility',
      definition: 'Non-brand impressions, clicks, landing pages, and query cohorts for the right audience, stage, product, service, and market.',
      source: 'Google Search Console, Bing Webmaster Tools, and controlled rank cohorts',
    },
    {
      name: 'Customer progression',
      definition: 'Meaningful page paths, calls, bookings, enquiries, trials, applications, product actions, store discovery, or other approved stages.',
      source: 'consent-aware analytics and business systems',
    },
    {
      name: 'AI-answer presence and accuracy',
      definition: 'Brand presence, citations, cited sources, framing, and factual accuracy for a stable commercially relevant prompt set.',
      source: 'versioned platform observations',
    },
    {
      name: 'Commercial outcomes',
      definition: 'Qualified leads, accepted opportunities, pipeline, orders, new customers, revenue, or other approved business outcomes by cohort.',
  ...
  evidence: {
    ...
    lead:
      'The figures below come from screenshots supplied and approved by the project owner. They are point-in-time observations with source context, not guarantees, universal averages, or proof that one tactic caused the result.',
    ...sharedIndustryEvidence,
    slots: [
      {
        label: 'Expressway.PH trend evidence',
        description: 'Reserved for the approved organic traffic and keyword trend with period and selected metrics visible.',
      },
      {
        label: 'TaxCalculator.com.ph search evidence',
        description: 'Reserved for the approved Google Search Console capture with period, clicks, and impressions visible.',
      },
    ],
  },
  ...
  sources: [
    {
      ...
      description: 'Google’s primary technical requirements, spam policies, and key best practices.',
    },
    {
      label: 'Google SEO Starter Guide',
      url: 'https://developers.google.com/search/docs/fundamentals/seo-starter-guide',
      description: 'Primary guidance for crawlable, understandable, useful search experiences.',
    },
    {
      label: 'Microsoft Bing Webmaster Guidelines',
      url: 'https://www.bing.com/webmasters/help/webmaster-guidelines-30fba23a',
      description: 'Primary guidance for eligible and discoverable content in Bing.',
    },
    {
      label: 'Google: AI features and your website',
      url: 'https://developers.google.com/search/docs/appearance/ai-features',
      description: 'Google guidance for its AI search experiences and site-owner controls.',
    },
  ],
  ...
  relatedLinks: [
    {
      ...
      label: 'Technical SEO',
      description: 'Crawling, rendering, indexation, templates, migrations, performance, and release QA.',
    },
    {
      href: '/services/content',
      label: 'SEO content services',
      description: 'Demand research, briefs, expert review, production, refreshes, and governance.',
    },
    {
  ...
  ctaTitle: 'Find the technical, content, authority, and measurement gaps holding search back.',
  ctaLead:
...
const technicalSeo: IndustryLeadPageData = {
  ...
  parentBreadcrumb: { name: 'Services', href: '/services' },
  name: 'Technical SEO',
  schemaName: 'Technical SEO audit, implementation, migration, and monitoring services',
  serviceType:
  ...
  searchJourneys: [
    {
      ...
      conversion: 'crawler evidence, log investigation, and prioritized discovery fixes',
    },
    {
      stage: 'Render',
      ...
      examples: ['React pages not indexed', 'product links only available after interaction'],
      conversion: 'render comparison, template requirements, and engineering ticket',
    },
    {
      stage: 'Index',
      ...
      examples: ['duplicate locale pages', 'canonical chosen differently by Google'],
      conversion: 'URL-state model, canonical and consolidation fix, and validation',
    },
    {
      stage: 'Perform',
      ...
      examples: ['LCP regression after redesign', 'structured data no longer matches product page'],
      conversion: 'release safeguard, monitoring rule, and measurable page improvement',
    },
  ],
  ...
  aiVisibility: {
    ...
    lead:
      'Yes, when an AI experience relies on web search, retrieval, crawling, or accessible page content. Technical SEO cannot guarantee citation, but blocked resources, client-only facts, weak internal links, duplicate ownership, and stale or inaccessible sources can reduce eligibility and clarity.',
    platforms: [
      'Google Search',
      'Google AI Overviews',
      'Google AI Mode',
    ...
    workstreams: [
      ...
      },
      {
        ...
        output: 'render samples, content-access requirements, and template tickets',
      },
      {
  ...
  architecture: [
    {
      ...
      examples: 'indexable, canonicalized, redirected, archived, unavailable, noindex, blocked',
      signal: 'business purpose, status, canonical, internal links, sitemap, and lifecycle rule',
    },
    {
      pageType: 'Rendering contract',
      intent: 'What must appear without fragile client behavior?',
      examples: 'metadata, headings, content, links, product facts, status, error state',
      signal: 'server and rendered expectations, resources, timeout, fallback, and test',
    },
    {
      pageType: 'Template and facet rules',
      intent: 'Which generated states deserve search ownership?',
      examples: 'category, product, filter, sort, search, map, profile, tag, pagination',
      signal: 'demand, uniqueness, inventory, crawl path, canonical, and no-result behavior',
    },
    {
      pageType: 'International relationships',
      intent: 'Which audience does each version serve?',
      examples: 'language, region, currency, country, global, translated, localized',
      signal: 'URL, locale, hreflang, canonical, navigation, content, and fallback rules',
    },
    {
      pageType: 'Release and incident controls',
      intent: 'How do we prevent and respond to regressions?',
      examples: 'pre-launch tests, alerts, migration checks, rollback, traffic incident',
      signal: 'owner, threshold, evidence, escalation, acceptance, and recovery procedure',
    },
  ],
  ...
  process: [
    {
      ...
      output: 'system diagram, access plan, template inventory, and risk register',
    },
    {
      number: '02',
      cadence: 'Weeks 1–2',
      ...
      output: 'reproducible findings, affected cohorts, evidence files, and data limitations',
    },
    {
      number: '03',
      cadence: 'Weeks 2–3',
      ...
      output: 'prioritized backlog, decision rationale, and implementation sequence',
    },
    {
      number: '04',
      cadence: 'Weeks 2–5',
      ...
      output: 'developer tickets, diagrams, test cases, and stakeholder walkthrough',
    },
    {
      number: '05',
      ...
      output: 'QA results, resolved defects, exceptions, and release annotations',
    },
    {
      number: '06',
      cadence: 'Ongoing',
      ...
      output: 'monitors, alerts, runbooks, training, and quarterly technical roadmap',
    },
  ],
  ...
  measurement: [
    {
      name: 'Implementation',
      definition: 'Priority tickets accepted, shipped, and validated against stated acceptance criteria across representative edge cases.',
      source: 'project tracker, release records, test evidence, and production QA',
    },
    {
      name: 'Crawl and index state',
      definition: 'Discovery, fetch, status, canonical selection, valuable indexed pages, excluded states, crawl demand, and sitemap consistency.',
      source: 'crawler, logs where available, Search Console, and URL samples',
    },
    {
      name: 'Rendering and performance',
      definition: 'Critical content and links present, render failures resolved, and Core Web Vitals or user-impact metrics improved by template cohort.',
      source: 'render tests, browser monitoring, CrUX or field data, and lab diagnostics',
    },
    {
      name: 'Search visibility cohort',
      definition: 'Impressions, clicks, queries, and landing-page changes for the exact templates or routes affected by the release.',
      source: 'Google Search Console, Bing Webmaster Tools, and annotated cohorts',
    },
    {
      name: 'Commercial protection or growth',
      definition: 'Preserved or improved qualified actions and revenue exposure associated with priority templates, especially through migrations.',
  ...
  evidence: {
    ...
    lead:
      'Current public results show the scale of search and AI visibility on owner-approved projects. They do not isolate technical SEO as the sole cause. Technical case evidence will be added only with an approved before state, release, period, and method.',
    ...sharedIndustryEvidence,
    slots: [
      {
        label: 'Technical before-and-after',
        description: 'Reserved for an approved crawl, render, index, or Core Web Vitals cohort with release context.',
      },
      {
        label: 'Migration or release validation',
        description: 'Reserved for an approved URL sample, redirect or template result, date, and acceptance criteria.',
      },
    ],
  },
  ...
  sources: [
    {
      ...
      description: 'Primary overview of Google discovery, crawling, rendering, and indexing.',
    },
    {
      label: 'Google: JavaScript SEO basics',
      url: 'https://developers.google.com/search/docs/crawling-indexing/javascript/javascript-seo-basics',
      description: 'Primary guidance for JavaScript rendering, links, status, and content.',
    },
    {
    ...
    },
    {
      ...
      description: 'Primary definitions and measurement guidance for Core Web Vitals.',
    },
  ],
  ...
  relatedLinks: [
    {
      ...
      description: 'A broader technical, content, authority, competitor, and measurement diagnostic.',
    },
    {
      href: '/services/ecommerce-seo',
      label: 'Ecommerce SEO',
      description: 'Catalogs, facets, product lifecycle, feeds, migrations, and revenue cohorts.',
    },
    {
      href: '/services/enterprise-seo',
      label: 'Enterprise SEO',
      description: 'Governance, automation, cross-team implementation, and large-scale monitoring.',
    },
    {
      href: '/services/ai-search',
      label: 'AI search optimization',
  ...
  ctaTitle: 'Turn crawler warnings and search symptoms into implementable technical decisions.',
  ctaLead:
...
const seoAudit: IndustryLeadPageData = {
  ...
  searchJourneys: [
    {
      ...
      examples: ['organic traffic dropped after redesign', 'valuable pages not indexed'],
    ...
    },
    {
      ...
      conversion: 'preservation requirements, pre-launch tests, and monitoring plan',
    },
    {
      stage: 'Validate',
      ...
      examples: ['independent SEO audit for board review', 'validate AI SEO agency reporting'],
      conversion: 'independent findings, data limitations, decision options, and governance',
    },
  ],
  ...
  aiVisibility: {
    ...
    lead:
      'An AI-search audit should be reproducible enough to guide work. A screenshot of one flattering ChatGPT answer is not a baseline. The prompt, platform, model or mode where known, market, date, answer, sources, competitors, and facts must be recorded.',
    platforms: [
      'Google AI Overviews',
      'Google AI Mode',
      'Bing Copilot',
    ...
    workstreams: [
      {
        ...
        output: 'prompt inventory, test conditions, answer captures, and competitor observations',
      },
      {
        ...
        output: 'source graph, cited-page patterns, gaps, and correction opportunities',
      },
      {
        ...
        output: 'accuracy log, entity contradictions, claim owners, and priority corrections',
      },
      {
        ...
        output: 'AI-search backlog integrated with technical, content, and authority priorities',
      },
    ],
  },
  ...
  architecture: [
    {
      ...
      examples: 'performance narrative, major causes, risks, opportunities, and choices',
      signal: 'plain language, evidence, materiality, uncertainty, and recommended direction',
    },
    {
      pageType: 'Finding register',
      intent: 'What exactly was observed?',
      examples: 'finding ID, category, evidence, affected cohort, impact, confidence',
      signal: 'reproducible test, examples, scope, exceptions, and source files',
    },
    {
      pageType: 'Implementation backlog',
      intent: 'What must each team do?',
      examples: 'owner, recommendation, priority, dependency, effort, acceptance, validation',
      signal: 'specific expected behavior, affected patterns, edge cases, and release order',
    },
    {
      pageType: 'Page and URL decisions',
      intent: 'Which assets should change?',
      examples: 'keep, improve, create, merge, redirect, archive, delete, or monitor',
      signal: 'URL list, intent owner, evidence, destination, content requirement, and risk',
    },
    {
      pageType: 'Measurement and follow-up',
      intent: 'How will we know the work shipped and mattered?',
      examples: 'baseline, cohort, event, search metric, commercial stage, checkpoint',
      signal: 'source, definition, owner, cadence, limitation, and next decision',
    },
  ],
  ...
  process: [
    {
      ...
      output: 'audit charter, access list, stakeholder plan, assumptions, and success criteria',
    },
    {
      number: '02',
      cadence: 'Week 1',
      ...
      output: 'evidence inventory, baseline views, data-quality issues, and sampling plan',
    },
    {
      number: '03',
      cadence: 'Weeks 1–2',
      ...
      output: 'finding register with evidence, affected cohorts, confidence, and exceptions',
    },
    {
      number: '04',
      cadence: 'Weeks 2–3',
      ...
      output: 'sequenced roadmap, developer tickets, page decisions, and decision options',
    },
    {
      number: '05',
      cadence: 'Week 3',
      ...
      output: 'executive deck, working session, updated decisions, and assigned backlog',
    },
    {
      number: '06',
      ...
      output: 'implementation review, validation results, exceptions, and next decisions',
    },
  ],
  ...
  measurement: [
    {
      ...
      definition: 'Material findings have reproducible tests, affected cohorts, examples, sources, confidence, exceptions, and a clear causal hypothesis.',
      source: 'finding register and supporting evidence files',
    },
    {
      name: 'Decision and ownership',
      definition: 'Priority work has an agreed outcome, owner, dependency, sequence, acceptance criteria, and explicit decision to ship, test, defer, or reject.',
      source: 'roadmap, decision log, and project system',
    },
    {
      name: 'Implementation progress',
      definition: 'Recommendations accepted, released, and validated across representative pages and templates without material regression.',
      source: 'tickets, release records, crawler, Search Console, and QA evidence',
    },
    {
      name: 'Search cohort change',
      definition: 'Index, impressions, clicks, landing pages, and query visibility for the pages and templates affected by implemented work.',
      source: 'Google Search Console, Bing Webmaster Tools, and annotated cohorts',
    },
    {
      name: 'Commercial cohort change',
      definition: 'Qualified actions, leads, product usage, bookings, orders, pipeline, or revenue for affected landing-page and customer cohorts.',
      source: 'approved analytics and business systems with attribution limitations',
    },
  ],
  evidence: {
    title: 'What audit evidence can you inspect?',
    lead:
      'The public numbers below are approved project snapshots used to demonstrate source context and measurement discipline. An audit sample will be added only after confidential data is removed and every finding, screenshot, date, and permission is approved.',
    ...sharedIndustryEvidence,
    slots: [
      {
        label: 'Redacted audit finding',
        description: 'Reserved for evidence, affected cohort, priority, recommendation, owner, and acceptance criteria.',
      },
      {
        label: 'Roadmap and validation sample',
        description: 'Reserved for a redacted priority board or released-fix validation with date and method.',
      },
    ],
  },
  ...
  sources: [
    {
      label: 'Google Search Essentials',
      url: 'https://developers.google.com/search/docs/essentials',
      description: 'Primary requirements and policies used when evaluating search eligibility and spam risk.',
    },
    {
      ...
      description: 'Primary framework for investigating technical, algorithmic, demand, and reporting causes.',
    },
    {
      label: 'Google: crawling and indexing',
      url: 'https://developers.google.com/search/docs/crawling-indexing/overview',
      description: 'Primary overview used to distinguish discovery, crawling, rendering, and indexing conditions.',
    },
    {
      label: 'Microsoft Bing Webmaster Guidelines',
      url: 'https://www.bing.com/webmasters/help/webmaster-guidelines-30fba23a',
      description: 'Primary Bing guidance considered in cross-engine technical and content review.',
    },
  ],
  ...
  relatedLinks: [
    {
      href: '/services/technical-seo',
      label: 'Technical SEO',
      description: 'Deep crawl, render, index, template, performance, migration, and implementation work.',
    },
    {
      href: '/services/seo-consulting',
      label: 'SEO consulting',
      description: 'Independent strategy, prioritization, stakeholder guidance, and ongoing decision support.',
    },
    {
      href: '/methodology',
      label: 'Our methodology',
      description: 'How evidence, confidence, prioritization, review, implementation, and measurement work.',
    },
    {
      href: '/pricing',
      label: 'SEO pricing',
      description: 'Engagement models, starting investment, scope variables, and fit.',
    },
  ],
  ctaEyebrow: 'Get a decision-ready diagnosis',
  ctaTitle: 'Find the causes, risks, and opportunities your next SEO roadmap should address.',
  ctaLead:
