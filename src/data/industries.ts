...
export const industries: Industry[] = [
  { slug: 'saas', name: 'SaaS', priorityServiceSlugs: ['seo', 'google-ads', 'aeo', 'content'], status: 'live', launchPhase: 'M1' },
  ...
  { slug: 'fashion', name: 'Fashion', priorityServiceSlugs: ['ecommerce-seo', 'image-seo', 'content', 'meta-ads'], status: 'live', launchPhase: 'M1' },
  { slug: 'travel', name: 'Travel', priorityServiceSlugs: ['content', 'technical-seo', 'aeo', 'programmatic-seo'], status: 'live', launchPhase: 'M1' },
  ...
  { slug: 'technology', name: 'Technology', priorityServiceSlugs: ['seo', 'aeo', 'content', 'digital-pr'], status: 'live', launchPhase: 'M1' },
  ...
  { slug: 'ai', name: 'AI Companies', priorityServiceSlugs: ['aeo', 'entity-seo', 'digital-pr', 'content'], status: 'live', launchPhase: 'M1' },
  { slug: 'food', name: 'Food & Beverage', priorityServiceSlugs: ['local-seo', 'content', 'image-seo', 'ecommerce-seo'], status: 'live', launchPhase: 'M1' },
  // 4 new
