...
const retiredToolRedirects = [
  ...
  {
    source: "/tools/content-brief-generator",
    destination: "/services/content",
  },
  {
    source: "/tools/sitemap-generator",
    destination: "/services/technical-seo",
  },
...
export const redirects: Redirect[] = [
  ...
  // Valuable historical URLs surfaced in Search Console. Preserve intent
  // without masking unrelated retired theme/demo URLs with homepage redirects.
  { source: "/faq", destination: "/#faq", permanent: true },
  {
    source: "/case-studies/automobile-seo",
    destination: "/case-studies/expressway-ph",
    permanent: true,
  },
  ...
  {
    source: "/services/aeo",
    destination: "/services/ai-search/aeo",
    permanent: true,
  },
  {
