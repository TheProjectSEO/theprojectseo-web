...
const content: IndustryLeadPageData = {
  ...
  name: "SEO content",
  schemaName:
    "SEO content strategy, production, optimization, and governance services",
  serviceType:
  ...
  searchJourneys: [
    {
      ...
      examples: [
        "how to plan a Shopify migration",
        "what is generative engine optimization",
      ],
      conversion:
        "deeper resource, tool, newsletter, relevant product or service route",
    },
    {
      stage: "Solve",
      ...
      conversion:
        "solution, use-case, service, product, consultation, or trial exploration",
    },
    {
      stage: "Compare",
      ...
      examples: [
        ...
        "AI SEO agency comparison criteria",
      ],
      conversion:
        "comparison, pricing, evidence, demo, shortlist, or qualified enquiry",
    },
    {
      stage: "Validate",
      ...
      examples: [
        "agency x SEO audit deliverables",
        "product x implementation and support",
      ],
      conversion:
        "case study, methodology, service page, order, trial, or qualified opportunity",
    },
  ],
  ...
  aiVisibility: {
    ...
    lead: "Content should make useful facts and answers explicit without becoming a stack of shallow questions. AI systems may retrieve owned pages or third-party sources, so clarity, evidence, entities, corroboration, and technical access matter together.",
    platforms: [
      "Google Search",
      "Google AI Overviews",
      "Google AI Mode",
    ...
    workstreams: [
      {
        ...
        output:
          "answer inventory, extractable passages, definitions, tables, and limitations",
      },
      {
      ...
      },
      {
        ...
        output:
          "entity map, canonical page roles, link plan, and structured-data recommendations",
      },
      {
        ...
        output:
          "versioned prompt set, source observations, accuracy log, and refresh priorities",
      },
    ],
  },
  ...
  architecture: [
    {
      ...
      examples:
        "service, product, category, solution, use case, industry, and location",
      signal:
        "explicit offer, audience, facts, proof, fit, boundaries, and action",
    },
    {
      pageType: "Evaluation pages",
      intent: "How should I choose?",
      examples:
        "comparison, alternative, pricing, implementation, integration, and criteria",
      signal:
        "declared method, balanced differences, current evidence, and decision path",
    },
    {
      pageType: "Educational resources",
      intent: "Help me understand or complete a task",
      examples:
        "guides, tutorials, glossaries, research, checklists, and examples",
      signal:
        "original utility, expert or source review, completeness, and relevant next step",
    },
    {
      pageType: "Tools and original assets",
      intent: "Help me calculate, diagnose, compare, or decide",
      examples:
        "calculators, templates, datasets, benchmarks, audits, and interactive tools",
      signal:
        "working utility, transparent method, inputs, limitations, ownership, and maintenance",
    },
    {
      pageType: "Evidence and trust",
      intent: "Can I verify the organization and claim?",
      examples:
        "case studies, methodology, authors, reviews, policies, and source pages",
      signal:
        "approved metrics, dates, source context, named responsibility, and limitations",
    },
  ],
  ...
  process: [
    {
      ...
      output:
        "source inventory, expert plan, audience map, claims, and measurement definitions",
    },
    {
      number: "02",
      cadence: "Weeks 1–3",
      ...
      output:
        "page decisions, opportunity map, baseline, and content-quality gaps",
    },
    {
      number: "03",
      cadence: "Weeks 3–4",
    ...
    },
    {
      ...
      output:
        "approved page, metadata, links, schema, visual brief, and QA record",
    },
    {
      number: "06",
      ...
      output:
        "content report, refresh decisions, experiment findings, and next roadmap",
    },
  ],
  ...
  measurement: [
    {
      ...
      definition:
        "Relevant impressions, clicks, query breadth, landing-page visibility, cannibalization, and eligible page types for the intended audience and task.",
      source:
        "Google Search Console, Bing Webmaster Tools, SERP and page cohorts",
    },
    {
      name: "Answer usefulness",
      definition:
        "Whether the page answers the intended question clearly, covers decision criteria, uses valid sources, passes expert review, and offers a useful next step.",
      source:
        "editorial QA, source register, reviewer record, and user evidence",
    },
    {
      name: "Customer progression",
      definition:
        "Relevant internal-link journeys, product or service exploration, tool completion, return visits, calls, forms, trials, bookings, or other page-specific actions.",
      source: "consent-aware analytics and business systems",
    },
    {
      name: "AI-answer presence and accuracy",
      definition:
        "Page or brand inclusion, cited source, framing, and factual accuracy for a stable question set related to the asset.",
      source: "versioned prompt observations",
    },
    {
      name: "Commercial contribution",
      definition:
        "Qualified leads, accepted opportunities, product use, orders, pipeline, revenue, or assisted outcomes associated with the page cohort.",
      source: "approved CRM, commerce, product, or attribution data",
    },
  ],
  evidence: {
    title: "What content evidence can you inspect?",
    lead: "The approved project snapshots below show search and AI-answer visibility for properties using this broader operating approach. They are not represented as content-only causation or universal client outcomes.",
    ...sharedIndustryEvidence,
    slots: [
      {
        label: "Content page cohort",
        description:
          "Reserved for approved pages, publication dates, query or landing-page metrics, and business context.",
      },
      {
        label: "Content citation example",
        description:
          "Reserved for a dated platform, exact prompt, cited page, source role, and accuracy review.",
      },
    ],
  },
  ...
  sources: [
    {
      ...
      description:
        "Google’s primary questions for useful, trustworthy content and self-assessment.",
    },
    {
      label: "Google Search Quality Evaluator Guidelines",
      url: "https://guidelines.raterhub.com/searchqualityevaluatorguidelines.pdf",
      description:
        "Public guidance used by raters; useful context, not a direct ranking checklist.",
    },
    {
      ...
      description:
        "Primary Google guidance emphasizing quality and purpose rather than production method.",
    },
    {
      label: "W3C Web Content Accessibility Guidelines",
      url: "https://www.w3.org/WAI/standards-guidelines/wcag/",
      description:
        "Primary accessibility standards informing semantic structure and usable content.",
    },
  ],
  ...
  relatedLinks: [
    {
      ...
      label: "On-page SEO",
      description:
        "Page intent, titles, headings, copy, entities, schema, links, and conversion paths.",
    },
    {
      href: "/services/ai-search",
      label: "AI search optimization",
      description:
        "Prompt, source, entity, citation, answer, and accuracy work.",
    },
    {
      href: "/services/seo-audit",
      label: "SEO audit services",
      description:
        "Technical, content, authority, competitor, analytics, and AI-search diagnosis.",
    },
    {
      href: "/methodology",
      label: "Our methodology",
      description:
        "Evidence, prioritization, expert review, implementation, QA, and measurement.",
    },
  ],
  ctaEyebrow: "Build content worth finding",
  ctaTitle:
    "Find the pages your audience needs—and the content you should improve or retire.",
  ctaLead:
...
const ecommerceSeo: IndustryLeadPageData = {
  ...
  searchJourneys: [
    {
      ...
      examples: [
        ...
        "standing desk for a small apartment",
      ],
      conversion:
        "category, collection, guide, finder, or relevant product exploration",
    },
    {
      stage: "Narrow",
      ...
      examples: [
        "waterproof trail shoes size 8",
        "USB-C dock for MacBook dual monitor",
      ],
      conversion:
        "curated category or useful filter landing page with available products",
    },
    {
      stage: "Evaluate",
      ...
      conversion:
        "qualified product view, comparison, wishlist, add to cart, or store lookup",
    },
    {
      stage: "Buy",
  ...
  obstaclesTitle:
    "Why does ecommerce SEO grow traffic without profitable orders?",
  obstaclesLead:
  ...
  aiVisibility: {
    ...
    lead: "AI answers and shopping experiences may compare products by use case, attribute, price, availability, reviews, and seller trust. Clear product data and useful category context matter, but current inventory and merchant systems remain authoritative.",
    platforms: [
      "Google Search",
      "Google AI Overviews",
      "Google AI Mode",
    ...
    workstreams: [
      {
        ...
        output:
          "product fact requirements, feed discrepancy log, schema plan, and freshness rules",
      },
      {
        ...
        output:
          "prompt taxonomy, category gaps, comparison roadmap, and source map",
      },
      {
        ...
        output:
          "entity graph, profile corrections, internal links, and corroboration targets",
      },
      {
        ...
        output:
          "dated platform observations, discrepancies, and priority corrections",
      },
    ],
  },
  ...
  architecture: [
    {
      ...
      examples:
        "department, category, subcategory, collection, brand, use case",
      signal:
        "distinct demand, sufficient inventory, curation, filters, context, links, and maintenance",
    },
    {
      pageType: "Approved facet landing",
      intent: "Show me products meeting an important constraint",
      examples:
        "material, size, compatibility, audience, price band, feature combination",
      signal:
        "stable demand, useful results, unique value, crawl control, and no empty state",
    },
    {
      pageType: "Product and variant",
      intent: "Is this exact item right and available?",
      examples:
        "product, model, SKU, variant, bundle, subscription, seller offer",
      signal:
        "specific facts, original value, current offer, media, reviews, policy, and purchase route",
    },
    {
      pageType: "Guide and comparison",
      intent: "Help me choose or use a product",
      examples:
        "buying guide, compatibility, how-to, alternatives, versus, care, troubleshooting",
      signal:
        "expert or source evidence, decision criteria, relevant available products, and date",
    },
    {
      pageType: "Store and trust",
      intent: "Can I buy from this seller confidently?",
      examples:
        "store, location, about, delivery, returns, warranty, contact, support",
      signal:
        "verified identity, current terms, real location or coverage, proof, and support route",
    },
  ],
  ...
  process: [
    {
      ...
      output:
        "system diagram, catalog and lifecycle map, owners, and outcome definitions",
    },
    {
      number: "02",
      cadence: "Weeks 1–3",
      ...
      output:
        "defect backlog, demand and taxonomy map, product discrepancies, and baseline",
    },
    {
      number: "03",
      cadence: "Weeks 3–5",
      ...
      output:
        "page map, template requirements, facet rules, briefs, and roadmap",
    },
    {
      number: "04",
      ...
      output:
        "released cohorts, QA evidence, resolved discrepancies, and decision log",
    },
    {
      number: "05",
      cadence: "Monthly",
      ...
      output:
        "content assets, relevant citations, entity fixes, and AI-answer experiments",
    },
    {
      number: "06",
      cadence: "Monthly / quarterly",
      ...
      output:
        "commercial report, lifecycle decisions, experiment findings, and next roadmap",
    },
  ],
  ...
  measurement: [
    {
      ...
      definition:
        "Non-brand impressions, clicks, landing pages, and query coverage by category, attribute, brand, product, market, and purchase stage.",
      source:
        "Google Search Console, Bing Webmaster Tools, and controlled cohorts",
    },
    {
      name: "Product discovery",
      definition:
        "Category engagement, product views, filter and site-search success, variant selection, wishlist, and add-to-cart behavior.",
      source: "consent-aware ecommerce analytics",
    },
    {
      name: "Organic commerce outcomes",
      definition:
        "Orders, new customers, revenue, average order value, cancellations, returns, and approved margin context by landing cohort.",
      source: "ecommerce platform and approved attribution model",
    },
    {
      name: "Catalog search health",
      definition:
        "Valuable indexable pages, duplicate or empty states, stock and lifecycle accuracy, product-feed consistency, and regressions.",
      source:
        "crawler, Search Console, catalog and feed data, logs, and release QA",
    },
    {
      name: "AI product visibility",
      definition:
        "Brand or product presence, cited sources, facts, availability, and buyable destination for stable commercial prompts.",
      source: "dated platform observations by market and wording",
    },
  ],
  evidence: {
    title: "What ecommerce SEO evidence can you inspect?",
    lead: "The current approved results demonstrate search and AI visibility in other business models. They are not presented as ecommerce revenue performance or proof that a single ecommerce tactic caused an outcome.",
    ...sharedIndustryEvidence,
    slots: [
      {
        label: "Ecommerce cohort evidence",
        description:
          "Reserved for approved categories or products, dates, stock, search, orders, revenue, and attribution context.",
      },
      {
        label: "Catalog technical example",
        description:
          "Reserved for an approved facet, lifecycle, feed, render, or migration before-and-after with validation.",
      },
    ],
  },
  ...
  sources: [
    {
      ...
      description:
        "Primary guidance for navigation, links, categories, and product discovery.",
    },
    {
      label: "Google: product structured data",
      url: "https://developers.google.com/search/docs/appearance/structured-data/product",
      description:
        "Primary requirements for visible, accurate product and offer information.",
    },
    {
      ...
      description:
        "Primary technical guidance for managing filtered URL spaces.",
    },
    {
      label: "Google Merchant Center product data specification",
      url: "https://support.google.com/merchants/answer/7052112",
      description:
        "Primary definitions for common merchant product data fields.",
    },
  ],
  ...
  relatedLinks: [
    {
      ...
      label: "Shopify SEO",
      description:
        "A focused Shopify and Shopify Plus page for themes, collections, markets, apps, and growth.",
    },
    {
      href: "/industries/ecommerce",
      label: "SEO for ecommerce companies",
      description:
        "Industry strategy across shopper journeys, merchandising, operations, and AI discovery.",
    },
    {
      href: "/services/technical-seo",
      label: "Technical SEO",
      description:
        "Facets, rendering, indexation, migrations, performance, and release QA.",
    },
    {
      href: "/services/ai-search",
      label: "AI search optimization",
      description:
        "Product prompts, facts, entities, sources, citations, and accuracy monitoring.",
    },
    {
      href: "/blog/e-commerce-seo-strategy",
      label: "Ecommerce SEO strategy",
      description:
        "Use the complete guide to category, product, technical, content, authority, and measurement priorities.",
    },
    {
      href: '/blog/e-commerce-seo-strategy',
  ...
  ctaTitle:
    "Find where your catalog, products, and platform lose qualified shoppers.",
  ctaLead:
...
const localSeo: IndustryLeadPageData = {
  ...
  searchJourneys: [
    {
      ...
      examples: [
        "technical SEO consultant in Manila",
        "car service center in Pune",
      ],
      conversion:
        "local result, service page, category page, or relevant branch",
    },
    {
      stage: "Qualify",
      ...
      examples: [
        "clinic x open Sunday",
        "agency serving SaaS companies in Bangalore",
      ],
      conversion:
        "profile action, location page, service detail, call, message, or booking",
    },
    {
      stage: "Trust",
      ...
      conversion:
        "review and evidence visit, directions, call, appointment, or shortlist",
    },
    {
      stage: "Act",
      ...
      conversion:
        "qualified call, route request, booking, visit, order, or accepted local lead",
    },
  ],
  ...
  aiVisibility: {
    ...
    lead: "AI assistants may combine search results, maps, profiles, reviews, directories, publishers, and website pages when answering local questions. Consistent business, place, service, and reputation facts reduce ambiguity.",
    platforms: [
      "Google Search",
      "Google Maps",
      "Google AI Overviews",
    ...
    workstreams: [
      {
        ...
        output:
          "local fact model, owner matrix, profile and website discrepancy log",
      },
      {
        ...
        output:
          "prompt cohorts, source map, competitor observations, and answer gaps",
      },
      {
        ...
        output:
          "entity graph, citation priorities, review insights, and structured-data plan",
      },
      {
        ...
        output:
          "dated observations, factual exceptions, and priority corrections",
      },
    ],
  },
  ...
  architecture: [
    {
      ...
      signal:
        "real operating knowledge, market facts, services, cities, evidence, and contact path",
    },
    {
      pageType: "City or service area",
      intent: "Can this business serve my city?",
      examples:
        "city hub, legitimate service area, market-specific service route",
      signal:
        "real coverage, service details, local context, proof, limitations, and next action",
    },
    {
      ...
      signal:
        "verified address, hours, phone, services, people, media, access, reviews, and map",
    },
    {
      pageType: "Department or practitioner",
      intent: "Who provides this specialized service here?",
      examples:
        "eligible department, professional, doctor, lawyer, agent, service team",
      signal:
        "platform eligibility, real affiliation, schedule, expertise, location, and booking route",
    },
    {
      pageType: "Location-specific service",
      intent: "Is this exact service available in the area?",
      examples:
        "service + city when offer, audience, proof, process, or constraints differ",
      signal:
        "distinct local value, responsible location, evidence, availability, and conversion path",
    },
  ],
  ...
  process: [
    {
      ...
      output:
        "verified entity inventory, owner matrix, eligibility notes, and outcome definitions",
    },
    {
      number: "02",
      cadence: "Weeks 1–2",
    ...
    },
    {
      ...
      output:
        "entity and page map, content requirements, citation plan, and roadmap",
    },
    {
      number: "04",
      cadence: "Monthly",
    ...
    },
    {
      ...
      output:
        "review process, citation improvements, local assets, and entity consistency",
    },
    {
      number: "06",
      cadence: "Monthly / quarterly",
      ...
      output:
        "local commercial report, fact refreshes, experiments, and next roadmap",
    },
  ],
  ...
  measurement: [
    {
      ...
      definition:
        "Profile, local-pack, organic, and landing-page visibility by service, location, city, market, device, and query cohort.",
      source:
        "Google Search Console, Bing, eligible profile data, and controlled local observations",
    },
    {
      name: "Profile and entity health",
      definition:
        "Eligible claimed profiles with correct categories, services, hours, address or area, phone, website, ownership, and no material duplicates.",
      source:
        "profile inventory, website facts, platform records, and change log",
    },
    {
      name: "Local customer actions",
      definition:
        "Calls, messages, directions, bookings, appointments, orders, store-locator use, and location-page actions by branch and service.",
      source: "approved platform, call, booking, website, and commerce systems",
    },
    {
      name: "Qualified local outcomes",
      definition:
        "Accepted leads, attended appointments, visits, qualified calls, sales, or revenue after excluding spam, duplicates, jobs, and unsupported demand.",
      source: "CRM, booking, call review, POS, or approved business system",
    },
    {
      name: "AI local answer accuracy",
      definition:
        "Business inclusion, cited sources, and accuracy for service, location, hours, contact, category, and reputation prompts.",
      source: "dated platform observations by market and wording",
    },
  ],
  evidence: {
    title: "What local SEO evidence can you inspect?",
    lead: "The current approved examples demonstrate strong search and AI visibility in the Philippines. They are not represented as local-pack, call, booking, or store-visit performance unless that specific evidence is later approved.",
    ...sharedIndustryEvidence,
    slots: [
      {
        label: "Local profile and lead example",
        description:
          "Reserved for an approved location, period, profile or page actions, qualification rules, and method.",
      },
      {
        label: "Local AI-answer example",
        description:
          "Reserved for a dated service-and-place prompt, cited source, business fact, and accuracy check.",
      },
    ],
  },
  ...
  sources: [
    {
      ...
      description:
        "Primary guidelines for representing eligible businesses, locations, and service areas.",
    },
    {
      label: "Google: improve local ranking",
      url: "https://support.google.com/business/answer/7091",
      description:
        "Primary guidance on local information, relevance, distance, and prominence.",
    },
    {
      label: "Google Maps user-contributed content policy",
      url: "https://support.google.com/contributionpolicy/answer/7400114",
      description:
        "Primary policies relevant to reviews and prohibited manipulation.",
    },
    {
      label: "Google: LocalBusiness structured data",
      url: "https://developers.google.com/search/docs/appearance/structured-data/local-business",
      description:
        "Primary requirements for visible local business structured information.",
    },
  ],
  ...
  relatedLinks: [
    {
      ...
      label: "SEO in India",
      description:
        "Country and city discovery grounded in real operating knowledge.",
    },
    {
      href: "/locations/philippines",
      label: "SEO in the Philippines",
      description:
        "Country and city discovery grounded in Philippine search and market experience.",
    },
    {
      href: "/services/ai-search",
      label: "AI search optimization",
      description:
        "Local prompts, sources, entities, recommendations, and accuracy monitoring.",
    },
    {
      href: "/services/technical-seo",
      label: "Technical SEO",
      description:
        "Location templates, rendering, indexation, structured data, performance, and QA.",
    },
    {
      href: "/blog/local-seo-complete-guide",
      label: "Local SEO guide",
      description:
        "Review profiles, location pages, reviews, citations, local authority, and measurement in one workflow.",
    },
    {
      href: '/blog/local-seo-complete-guide',
  ...
  ctaTitle:
    "Find where profiles, location pages, reviews, and lead routing lose customers.",
  ctaLead:
...
const seoConsulting: IndustryLeadPageData = {
  ...
  searchJourneys: [
    {
      ...
      examples: [
        "independent SEO second opinion",
        "organic traffic drop consultant",
      ],
      conversion:
        "focused audit, diagnostic workshop, evidence plan, or decision memo",
    },
    {
      stage: "Decide",
      ...
      examples: [
        "SEO strategy for international expansion",
        "SSR vs client rendering SEO",
      ],
      conversion:
        "options analysis, recommendation, roadmap, and executive alignment",
    },
    {
      stage: "Deliver",
      ...
      examples: [
        "SEO consultant for website migration",
        "technical SEO sprint support",
      ],
      conversion:
        "tickets, brief standards, sprint guidance, QA, and release validation",
    },
    {
      stage: "Enable",
      ...
      examples: [
        "enterprise SEO governance consultant",
        "SEO training for content team",
      ],
      conversion:
        "playbook, training, monitoring, operating cadence, and internal ownership",
    },
  ],
  ...
  aiVisibility: {
    ...
    lead: "AI search introduces new vendor claims, metrics, platform behavior, and organizational questions. Consulting should help the team distinguish controllable source work from black-box volatility and integrate it with established SEO, content, authority, and analytics.",
    platforms: [
      "Google Search",
      "Google AI Overviews",
      "Google AI Mode",
    ...
    workstreams: [
      {
        ...
        output:
          "AI-search charter, owners, prompt taxonomy, and measurement boundaries",
      },
      {
        ...
        output:
          "requirements, comparison framework, test plan, and procurement questions",
      },
      {
        ...
        output:
          "prioritized backlog, dependencies, owners, and controlled experiments",
      },
      {
        ...
        output:
          "decision memo, confidence notes, risks, and next-quarter choices",
      },
    ],
  },
  ...
  architecture: [
    {
      ...
      examples:
        "question, owner, context, scope, constraints, evidence, deadline, success",
      signal:
        "clear authority, excluded work, assumptions, and decision criteria",
    },
    {
      pageType: "Evidence and options",
      intent: "What do we know and what choices exist?",
      examples:
        "data, tests, affected cohorts, hypotheses, alternatives, risks, trade-offs",
      signal:
        "sources, confidence, limitations, feasibility, and reversible tests",
    },
    {
      pageType: "Roadmap and specifications",
      intent: "What happens next?",
      examples:
        "priority, owner, dependency, milestone, ticket, brief, acceptance, validation",
    ...
    },
    {
      ...
      examples:
        "roles, workflow, checklist, template, review, escalation, release, incident",
    ...
    },
    {
      ...
      examples:
        "baseline, cohort, event, dashboard, prompt, checkpoint, experiment",
      signal:
        "definition, source, cadence, limitation, threshold, and next decision",
    },
  ],
  ...
  process: [
    {
      ...
      output:
        "consulting charter, access, interview plan, assumptions, and milestones",
    },
    {
      number: "02",
      cadence: "Week 1",
      ...
      output:
        "evidence inventory, stakeholder map, contradictions, and hypotheses",
    },
    {
      number: "03",
      cadence: "Weeks 1–2",
      ...
      output:
        "findings, confidence, decision options, trade-offs, and recommendation",
    },
    {
      number: "04",
      cadence: "Weeks 2–3",
      ...
      output:
        "roadmap, decision memo, tickets or briefs, and stakeholder workshop",
    },
    {
      number: "05",
      ...
      output:
        "review notes, accepted decisions, QA evidence, and updated playbook",
    },
    {
      number: "06",
      cadence: "Monthly / quarterly",
      ...
      output:
        "decision report, training, process changes, and next priorities or handoff",
    },
  ],
  ...
  measurement: [
    {
      ...
      definition:
        "Material questions reach an evidence-backed decision with stated confidence, trade-offs, ownership, scope, and timing.",
      source: "decision memos, meeting records, and stakeholder sign-off",
    },
    {
      name: "Implementation readiness",
      definition:
        "Priority work has feasible specifications or briefs, owners, dependencies, acceptance criteria, and validation plans.",
      source: "roadmap, tickets, briefs, and project system",
    },
    {
      name: "Shipped and validated change",
      definition:
        "Recommendations are implemented and confirmed across representative pages, templates, markets, or workflows.",
      source:
        "release record, crawl, Search Console, content QA, and production checks",
    },
    {
      name: "Team capability",
      definition:
        "Named owners can apply documented decision rules, run checks, maintain standards, and escalate material exceptions.",
      source: "playbooks, training, workflow adoption, and error recurrence",
    },
    {
      name: "Search and commercial outcomes",
      definition:
        "Qualified visibility, customer progression, leads, pipeline, orders, revenue, or risk protection for affected cohorts after implementation.",
      source:
        "approved search, analytics, product, CRM, commerce, or booking data",
    },
  ],
  evidence: {
    title: "What consulting evidence can you inspect?",
    lead: "The approved project figures below demonstrate hands-on operating experience, not guaranteed consulting outcomes. Redacted decision and implementation artifacts will be added only after client permission and factual review.",
    ...sharedIndustryEvidence,
    slots: [
      {
        label: "Consulting decision artifact",
        description:
          "Reserved for a redacted decision, evidence, options, recommendation, owner, and accepted outcome.",
      },
      {
        label: "Implementation validation",
        description:
          "Reserved for an approved release, affected cohort, expected behavior, and measured validation.",
      },
    ],
  },
  ...
  sources: [
    {
      ...
      description:
        "Primary Google technical requirements, policies, and best practices.",
    },
    {
      ...
      description:
        "Primary framework for investigating search performance changes.",
    },
    {
      ...
      description:
        "Primary context for international architecture and geographic targeting decisions.",
    },
    {
      label: "Google: AI features and your website",
      url: "https://developers.google.com/search/docs/appearance/ai-features",
      description:
        "Primary Google guidance relevant to AI-search strategy and site controls.",
    },
  ],
  ...
  relatedLinks: [
    {
      ...
      label: "SEO audit services",
      description:
        "Independent evidence, root-cause analysis, priorities, specifications, and validation.",
    },
    {
      href: "/services/technical-seo",
      label: "Technical SEO",
      description:
        "Crawl, render, index, migration, platform, performance, and release decisions.",
    },
    {
      href: "/methodology",
      label: "Our methodology",
      description:
        "Evidence, confidence, prioritization, review, implementation, and learning.",
    },
    {
      href: "/pricing",
      label: "Consulting and SEO pricing",
      description:
        "Starting investment, engagement models, scope variables, and fit.",
    },
  ],
  ctaEyebrow: "Make the next search decision clear",
  ctaTitle:
    "Bring us the SEO question your team cannot resolve with another dashboard.",
  ctaLead:
