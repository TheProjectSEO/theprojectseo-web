...
const aiSearch: IndustryLeadPageData = {
  ...
  searchJourneys: [
    {
      ...
      conversion:
        "qualified educational visit, deeper resource, newsletter, or relevant service path",
    },
    {
      stage: "Explore",
      ...
      examples: [
        "best approach to improve SaaS activation",
        "GEO vs SEO for a B2B company",
      ],
    ...
    },
    {
      ...
      examples: [
        "AI search SEO agency for fintech",
        "Shopify SEO agency for an international store",
      ],
      conversion:
        "brand search, service-page visit, comparison, enquiry, trial, or demo",
    },
    {
      stage: "Validate",
      ...
      examples: [
        "is agency x good for enterprise technical SEO",
        "product x alternatives and limitations",
      ],
      conversion:
        "evidence review, sales conversation, product evaluation, or qualified opportunity",
    },
  ],
  ...
  aiVisibility: {
    ...
    lead: "There is no universal “AI ranking factor.” Each experience has different retrieval, indexing, browsing, citation, freshness, personalization, and product behavior. The controllable work is improving eligible sources, brand facts, corroboration, and measurement.",
    platforms: [
      "Google AI Overviews",
      "Google AI Mode",
      "Bing Copilot",
    ...
    workstreams: [
      {
        ...
        output:
          "technical backlog, query and page map, search baseline, and implementation QA",
      },
      {
        ...
        output:
          "answer inventory, page briefs, fact tables, and review requirements",
      },
      {
        ...
        output:
          "entity map, inconsistency log, profile plan, and structured-data changes",
      },
      {
        ...
        output:
          "source graph, authority priorities, outreach angles, and correction opportunities",
      },
    ],
  },
  ...
  architecture: [
    {
      ...
      examples:
        "pillar pages, definitions, frameworks, glossaries, research, methodology",
      signal:
        "direct answer, scope, distinctions, evidence, expert ownership, and next step",
    },
    {
      pageType: "Product, service, and use case",
      intent: "Can this brand solve my specific job?",
      examples:
        "service, product, workflow, role, industry, integration, and location pages",
      signal:
        "explicit offer, audience, process, boundaries, proof, and conversion route",
    },
    {
      pageType: "Evaluation and comparison",
      intent: "How should I choose?",
      examples:
        "alternatives, versus pages, criteria, pricing, implementation, and fit",
      signal:
        "declared criteria, balanced differences, sources, limitations, and decision path",
    },
    {
      pageType: "Evidence and trust",
      intent: "Can I verify the company and its claims?",
      examples:
        "case studies, authors, reviewers, sources, policies, methodology, and company",
      signal:
        "approved facts, periods, methods, named responsibility, and no invented proof",
    },
    {
      pageType: "Third-party source assets",
      intent: "Where else can the brand be verified?",
      examples:
        "partner profiles, reviews, research citations, directories, publications, and video",
      signal:
        "independent relevance, consistent identity, substantive evidence, and current facts",
    },
  ],
  ...
  process: [
    {
      ...
      output:
        "commercial prompt inputs, entity inventory, claim owners, and outcome definitions",
    },
    {
      number: "02",
      cadence: "Weeks 1–3",
      ...
      output:
        "baseline, prompt taxonomy, source graph, competitor observations, and data limitations",
    },
    {
      number: "03",
      cadence: "Weeks 2–4",
      ...
      output:
        "prioritized technical, content, entity, authority, and measurement backlog",
    },
    {
      number: "04",
      cadence: "Monthly",
      ...
      output:
        "released changes, reviewed content, QA evidence, and decision log",
    },
    {
      number: "05",
      cadence: "Monthly",
      ...
      output:
        "source assets, earned placements, corrected profiles, and corroboration progress",
    },
    {
      number: "06",
      ...
      output:
        "visibility report, experiment readout, confidence notes, and next roadmap",
    },
  ],
  ...
  measurement: [
    {
      ...
      definition:
        "The share of a fixed, commercially relevant prompt set in which the brand or approved page appears, segmented by platform and intent.",
      source:
        "versioned prompt observations with platform, date, market, wording, and account state where known",
    },
    {
      name: "Citation and source presence",
      definition:
        "Whether the brand domain or a relevant third-party source is cited, which page supports the answer, and where it appears.",
      source: "captured answer and citation URLs",
    },
    {
      name: "Accuracy and framing",
      definition:
        "Whether material company, product, service, location, price-boundary, and evidence statements are correct and contextually useful.",
      source: "approved fact register and human review",
    },
    {
      name: "Google and Bing search demand",
      definition:
        "Impressions, clicks, page visibility, brand demand, and landing-page cohorts for related informational and commercial searches.",
      source:
        "Google Search Console, Bing Webmaster Tools, and approved rank cohorts",
    },
    {
      name: "Commercial outcomes",
      definition:
        "Qualified visits, enquiries, trials, demos, accepted leads, opportunities, pipeline, or revenue associated with relevant organic and known AI referrals.",
      source:
        "consent-aware analytics, self-reported attribution, and CRM where approved",
    },
  ],
  evidence: {
    title: "What AI-search evidence can you review?",
    lead: "The current public proof is limited to approved, point-in-time screenshots. The values below are shown with their source context and are not presented as guaranteed outcomes or universal benchmarks.",
    ...sharedIndustryEvidence,
    slots: [
      {
  ...
  relatedLinks: [
    ...
    },
    {
      ...
      description:
        "Prompt cohorts, mentions, citations, sources, accuracy, and reporting.",
    },
    {
  ...
  ctaTitle:
    "Find where your brand is absent, misrepresented, or supported by the wrong sources.",
  ctaLead:
