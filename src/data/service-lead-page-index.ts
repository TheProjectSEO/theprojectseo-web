...
export const servicesLeadPage = createSearchServicePage({
  ...
  examples: [
    "which SEO services does a growing company need",
    "SEO agency for Google and AI search",
    "technical SEO versus content and authority",
    "how to evaluate an AI-native SEO agency",
  ],
  pageAssets: [
    "home, service, product, category, solution, industry, and location pages",
    "comparison, alternative, pricing, methodology, evidence, and case-study pages",
    "guides, definitions, tools, documentation, examples, and support resources",
    "original research, data, expert commentary, visual evidence, and reference assets",
    "organization, people, author, reviewer, contact, location, policy, and profile pages",
  ],
  technicalFocus:
