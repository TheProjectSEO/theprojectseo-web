...
const coreSEOServices = [
  {
    ...
    desc: "Strategic SEO guidance",
  },
  {
    href: "/services/seo-audit",
    label: "SEO Audit",
    desc: "Comprehensive site analysis",
  },
  {
    href: "/services/technical-seo",
    label: "Technical SEO",
    desc: "Speed & crawlability",
  },
  {
  ...
  },
  {
    ...
    label: "Off-Page SEO",
    desc: "Link building & PR",
  },
  {
    href: "/services/link-building",
    label: "Link Building",
    desc: "White-hat link acquisition",
  },
];

const growthSEOServices = [
  {
    href: "/services/local-seo",
    label: "Local SEO",
    desc: "Google Business optimization",
  },
  {
    href: "/services/ecommerce-seo",
    label: "E-commerce SEO",
    desc: "Product page optimization",
  },
  {
    href: "/services/enterprise-seo",
    label: "Enterprise SEO",
    desc: "Large-scale SEO solutions",
  },
  {
    href: "/services/international-seo",
    label: "International SEO",
    desc: "Multi-country optimization",
  },
  {
    href: "/services/content",
    label: "SEO Content",
    desc: "Search-led content strategy",
  },
  {
    href: "/services/analytics",
    label: "SEO Analytics",
    desc: "Organic revenue attribution",
  },
];

const aiSearchServices = [
  {
    href: "/services/ai-search",
    label: "AI Search Optimization",
    desc: "Visibility across answer engines",
  },
  {
    href: "/services/ai-search/aeo",
    label: "AEO Services",
    desc: "Answer Engine Optimization",
  },
  {
  ...
  },
  {
    ...
    label: "AI Overviews",
    desc: "Win Google AI citations",
  },
  {
    href: "/services/ai-search/chatgpt-seo",
    label: "ChatGPT SEO",
    desc: "Earn ChatGPT citations",
  },
  {
    href: "/services/ai-search/llm-visibility-tracking",
    label: "LLM Visibility",
    desc: "Track AI-search share of voice",
  },
];

const seoSystemsServices = [
  {
    href: "/services/seo-automation",
    label: "SEO Automation",
    desc: "Automated SEO workflows",
  },
  {
    href: "/services/ai-agents/ai-seo-agent",
    label: "AI SEO Agent",
    desc: "Autonomous SEO operations",
  },
  {
    href: "/services/claude/agentic-seo-systems",
    label: "Agentic SEO Systems",
    desc: "Claude-powered SEO systems",
  },
  {
    href: "/services/analytics/seo-reporting",
    label: "SEO Reporting",
    desc: "Board-ready organic reporting",
  },
];
...
const locationLinks = [
  { href: "/locations/india", label: "India" },
        ...
        <div className="invisible absolute left-0 mt-2 w-[840px] origin-top-left border border-border-strong rounded-lg bg-white shadow-lg opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100 z-50">
          <div className="p-4">
            <div className="grid grid-cols-4 gap-6">
              {/* Core SEO */}
              <div>
                <h3 className="mb-3 text-xs font-mono uppercase tracking-wider text-ash">
                  Core SEO
                </h3>
                <div className="space-y-1">
                  {coreSEOServices.map(({ href, label, desc }) => (
                    <Link
                      key={href}
                      href={href}
                      className="block rounded-md px-2 py-2 group/item hover:bg-cream"
                    >
                      <div className="text-sm font-medium text-ink group-hover/item:text-accent">
                        {label}
                      </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {growthSEOServices.map(({ href, label, desc }) => (
                    <Link
                      key={href}
                      href={href}
                      className="block rounded-md px-2 py-2 group/item hover:bg-cream"
              ...
              <div>
                ...
                <div className="space-y-1">
                  {aiSearchServices.map(({ href, label, desc }) => (
                    <Link
                      key={href}
                      href={href}
                      className="block rounded-md px-2 py-2 group/item hover:bg-cream"
              ...
              <div>
                ...
                <div className="space-y-1">
                  {seoSystemsServices.map(({ href, label, desc }) => (
                    <Link
                      key={href}
                      href={href}
                      className="block rounded-md px-2 py-2 group/item hover:bg-cream"
            ...
            <div className="pb-4 pl-4 space-y-4">
              ...
              <details className="group/sub">
                ...
                <div className="pl-4 space-y-2 mt-2">
                  {coreSEOServices.map(({ href, label }) => (
                    <Link
                      key={href}
                      href={href}
                      onClick={closeMenu}
                      className="block text-sm text-slate hover:text-ink py-1"
                    >
                      {label}
                    </Link>
                  ))}
              ...
              <details className="group/sub">
                ...
                <div className="pl-4 space-y-2 mt-2">
                  {growthSEOServices.map(({ href, label }) => (
                    <Link
                      key={href}
                      href={href}
                      onClick={closeMenu}
              ...
              <details className="group/sub">
                ...
                <div className="pl-4 space-y-2 mt-2">
                  {aiSearchServices.map(({ href, label }) => (
                    <Link
                      key={href}
                      href={href}
                      onClick={closeMenu}
              ...
              <details className="group/sub">
                ...
                <div className="pl-4 space-y-2 mt-2">
                  {seoSystemsServices.map(({ href, label }) => (
                    <Link
                      key={href}
                      href={href}
                      onClick={closeMenu}
