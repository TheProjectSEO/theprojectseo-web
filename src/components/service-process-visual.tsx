 ...
 *
 * Design: rounded-none borders, accent/ink colors, connected nodes showing process flow
 */
        ...
        <div className="rounded-none border-2 border-accent bg-accent p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-ash mt-1">Crawl & analyze site</div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-none border border-accent bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Gather Data</div>
        ...
        <div className="rounded-none border-2 border-stone bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Findings</div>
        ...
        <div className="rounded-none border-2 border-accent bg-accent p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-ash mt-1">Competitor study</div>
            </div>
          </div>
        </div>
        <div className="absolute left-[38px] top-full h-6 w-0.5 bg-accent/20" />
        ...
        <div className="rounded-none border border-accent bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Content Strategy</div>
        ...
        <div className="rounded-none border-2 border-stone bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Roadmap</div>
        ...
        <div className="rounded-none border-2 border-accent bg-accent p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-ash mt-1">Code changes</div>
            </div>
          </div>
        </div>
        <div className="absolute left-[38px] top-full h-6 w-0.5 bg-accent/20" />
        ...
        <div className="rounded-none border border-accent bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Content Production</div>
        ...
        <div className="rounded-none border-2 border-stone bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Deploy</div>
        ...
        <div className="rounded-none border-2 border-accent bg-accent p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-ash mt-1">GA4, GSC, rankings</div>
            </div>
          </div>
        </div>
        <div className="absolute left-[38px] top-full h-6 w-0.5 bg-accent/20" />
      ...
      <div className="relative">
        <div className="rounded-none border border-accent bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="font-mono text-xs uppercase tracking-[0.1em] text-ash mb-1">Analyze</div>
              <div className="text-sm font-medium text-paper">Performance Review</div>
      ...
      <div className="relative">
        <div className="rounded-none border-2 border-stone bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="font-mono text-xs uppercase tracking-[0.1em] text-ash mb-1">Report</div>
              <div className="text-sm font-medium text-paper">Dashboard</div>
        ...
        <div className="rounded-none border-2 border-accent bg-accent p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-ash mt-1">Experiment & iterate</div>
            </div>
          </div>
        </div>
        <div className="absolute left-[38px] top-full h-6 w-0.5 bg-accent/20" />
        ...
        <div className="rounded-none border border-accent bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Continuous Improvement</div>
        ...
        <div className="rounded-none border-2 border-stone bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-paper">Growth</div>
