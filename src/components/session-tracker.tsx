...
function parseReferrer(ref: string): ReferrerInfo {
  ...
  if (host.includes("chatgpt.com") || host.includes("chat.openai.com")) {
    return { source: "chatgpt", query: null };
  }
  if (host.includes("perplexity.ai")) {
    return { source: "perplexity", query: null };
  }
  if (host.includes("claude.ai")) {
    return { source: "claude", query: null };
  }
  if (host.includes("gemini.google.com")) {
    return { source: "gemini", query: null };
  }
  if (host.includes("copilot.microsoft.com")) {
    return { source: "microsoft-copilot", query: null };
  }

  // Social
  if (host.includes("facebook.com") || host.includes("fb.com"))
    return { source: "facebook", query: null };
  if (
    host.includes("twitter.com") ||
    host.includes("x.com") ||
    host.includes("t.co")
  )
    return { source: "twitter", query: null };
