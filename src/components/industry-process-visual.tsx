/**
 * Industry Process Visualization Component
 *
 * Displays industry-specific workflow diagrams for SEO processes.
 * Used in the process section of industry pages.
 *
 * Design: rounded-none borders, accent/ink colors, industry-specific iconography
 */

interface IndustryProcessVisualProps {
  type: 'ai' | 'ecommerce' | 'saas' | 'healthcare' | 'finance' | 'legal' | 'realestate' | 'fashion' | 'automotive' | 'education' | 'travel' | 'nonprofit' | 'technology' | 'cybersecurity' | 'cannabis' | 'food'
}

export function IndustryProcessVisual({ type }: IndustryProcessVisualProps) {
  // Get industry-specific icon based on type
          ...
          <div className="rounded-none border-2 border-accent bg-accent p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-paper">Industry-Specific Audit</div>
                <div className="text-xs text-ash mt-1">Deep-dive analysis</div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-none border border-accent bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-paper">Strategy Development</div>
                <div className="text-xs text-ash mt-1">Custom roadmap</div>
              </div>
            </div>
          </div>
          <div className="absolute left-[38px] top-full h-6 w-0.5 bg-accent/20" />
          ...
          <div className="rounded-none border border-accent bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-paper">Content & Optimization</div>
                <div className="text-xs text-ash mt-1">Build & refine</div>
              </div>
            </div>
          </div>
          <div className="absolute left-[38px] top-full h-6 w-0.5 bg-accent/20" />
        ...
        <div className="relative">
          <div className="rounded-none border-2 border-stone bg-ink p-6 shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-mono text-xs uppercase tracking-[0.1em] text-ash mb-1">Grow</div>
                <div className="text-sm font-medium text-paper">Scale & Iterate</div>
                <div className="text-xs text-ash mt-1">Continuous improvement</div>
              </div>
            </div>
          </div>
        </div>
