...
export function buildLlmsTxt() {
  return [
    '# TheProjectSEO',
    '',
    '> TheProjectSEO is an AI-native SEO agency headquartered in Ranchi, India. It connects conventional SEO with generative engine optimization (GEO), answer engine optimization (AEO), technical implementation, content, entity development, authority, analytics, and prompt-level AI-search measurement across Google, Bing, AI Overviews, ChatGPT, Claude, Gemini, and Perplexity.',
    '',
    '## Important facts',
    '',
